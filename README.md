...
![alt text](https://img.shields.io/badge/Language-C%23-blueviolet)

![alt text](https://img.shields.io/badge/Framework-.NET%208-blue)

![alt text](https://img.shields.io/badge/Cloud-Azure-blue)

![alt text](https://img.shields.io/badge/CI/CD-GitHub%20Actions-lightgrey)
...
[INDSÆT SCREENSHOT HER AF "Figur 2: Systemarkitektur for AI-assistenten" FRA DIN RAPPORT]
🚀 Demo & Screenshots
TDD Kickstarter in Action
A generated C# xUnit test skeleton attached directly to the User Story in Azure DevOps.
[INDSÆT SCREENSHOT HER AF "Figur 10: Testfil vedhæftet i bilag for User story 1005" FRA DIN RAPPORT]
...
[INDSÆT SCREENSHOT HER AF "Figur 12: Kommentar i Azure Devops der viser fundne arkitektur-brud" FRA DIN RAPPORT]
...
Configure local.settings.json with the required Azure service keys and DevOps PAT.
...
🙏 Acknowledgments
